...
MESSAGE_DELIVERY_RETRY_ENABLED = _bool_env("MESSAGE_DELIVERY_RETRY_ENABLED", True)
MESSAGE_DELIVERY_RETRY_INTERVAL_SECONDS = int(os.getenv("MESSAGE_DELIVERY_RETRY_INTERVAL_SECONDS", "120"))
MESSAGE_DELIVERY_RETRY_BATCH_SIZE = int(os.getenv("MESSAGE_DELIVERY_RETRY_BATCH_SIZE", "5"))
